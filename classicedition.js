...
// Инициализация клетки "Старт"
// При проходе по этой клетке игрок получает $200
square[0] = new Square("Старт", "Получите $200 при прохождении", "#FFFFFF");

// Инициализация клетки "Житная"
// Задает название, цену, цвет и другие параметры недвижимости:
// $60 – стоимость покупки;
// 3 – номер группы, используемый для определения дополнительных цен (например, домов);
// 2 – базовая арендная плата (сниженная для клетки определенной группы);
// 10, 30, 90, 160, 250 – арендная плата с 1, 2, 3, 4 домами и с гостиницей соответственно.
square[1] = new Square(
  "Житная ул.",
  "$60",
  "#8B4513",
...
square[4] = new Square("Подоходный налог", "Заплатите $200", "#FFFFFF");
square[5] = new Square("Рижская железная дорога", "$200", "#FFFFFF", 200, 1);
square[6] = new Square(
  "Варшавское шоссе",
  "$100",
  "#87CEEB",
...
square[25] = new Square("Казанская железная дорога", "$200", "#FFFFFF", 200, 1);
...
square[35] = new Square("Ленинградская железная дорога", "$200", "#FFFFFF", 200, 1);
